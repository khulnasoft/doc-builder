...
project = "Mlkit"
copyright = "2023, Mlkit Team"
author = "Mlkit Team"

# The full version, including alpha/beta/rc tags
release = os.getenv("MLKIT_VERSION") or "dev"
...
html_theme_options = {
    ...
    "logo": {
        "image_light": "https://github.com/khulnasoft/khulnasoft.github.io/blob/main/img/externally_linked/mlkit_logo_new.svg?raw=true",  # noqa: E501
        "image_dark": "https://github.com/khulnasoft/khulnasoft.github.io/blob/main/img/externally_linked/mlkit_logo_new_dark.svg?raw=true",  # noqa: E501
        "link": "https://khulnasoft.com",
    },
    "switcher": {"version_match": release},
}

html_sidebars = {"**": ["custom-toc-tree", "mlkit-libraries"]}

html_title = "Mlkit Documentation"

html_favicon = (
    "https://github.com/khulnasoft/khulnasoft.github.io"
    + "/blob/main/img/externally_linked/mlkit_logo_only.png?raw=true"
)
...
def linkcode_resolve(domain, info):
    ...
    return f"https://github.com/khulnasoft/{repo_name}/blob/main/{mod_name}/{fn}{linespec}"
